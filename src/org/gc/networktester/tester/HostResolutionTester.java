...
public class HostResolutionTester implements Tester {
    ...
    public boolean performTest() {
        ...
        try {
            ...
            long time_two = SystemClock.uptimeMillis() - now;
            ...
            final String str = String.format( mainAct.getResources().getString( R.string.host_resolved ),
                                              time_one, time_two, Util.join( ip, "." ) );
